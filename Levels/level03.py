...
class Level03(Entity):
    def __init__(self):
        ...
        self.block_3_29 = SpeedBlock((784, 145, -10), (0, 270, 0))
        self.block_3_30 = SpeedBlock((755, 145, -10), (0, 270, 0))
        self.block_3_31 = SpeedBlock((720, 145, -10), (0, 270, 0))
        self.block_3_32 = SpeedBlock((680, 145, -10), (0, 270, 0))
        self.block_3_33 = SpeedBlock((630, 145, -10), (0, 270, 0))
        self.block_3_34 = SpeedBlock((570, 145, -10), (0, 270, 0))
    ...
    def update(self):
        ...
        elif hit.entity == self.block_3_29:
            self.player.jump_height = normalJump
        if hit.entity == self.block_3_29:
            self.player.SPEED = 4
